 ...
 *  @param numins          <br>
 *  @param outs  our output signal          <br>
 *  @param numouts         <br>
 *  @param n               <br>
 *  @param flags           <br>
 *  @param userparam       <br>
 ...
 *  @var   fractional_difference   fractional difference used for our simple linear interpolation    <br>
 *  @var   frac_delay                 <br>
 *  @var   samp1       used for linear interpolation and are taken from our delay line            <br>
 *  @var   samp2       used for linear interpolation and are taken from our delay line            <br>
 *  @var   int_delay                  <br>
